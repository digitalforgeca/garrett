...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/Version-1.6.4-blue?style=for-the-badge" alt="Version 1.6.4" />
...
* 🛡️ **100% Invisible Background Operation**:
...
6. Click the overlay **[ 🗝️ Keep Video ]** button to preserve the complete stream directly to disk.
...
├── popup.html            # Extension popup listing detected tab streams & DOM players
